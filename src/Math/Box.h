...
//=============================================================================
// Definitions
// Box:         Here, it is an axis-aligned box, the euclidian product of
//              intervals.
...
//              euclidian product of intervals and complementary of intervals.
...
Box<T, dim1 + dim2> operator* (Box<T, dim1> const& a, Box<T, dim2> const& b)
{
    Box<T, dim1 + dim2> r(uninitialized);
    r.min.SetSubVector(0, a.min);
    r.min.SetSubVector(dim1, b.min);
    r.max.SetSubVector(0, a.max);
    r.max.SetSubVector(dim1, b.max);
    return r;
}
//=============================================================================
template<typename T, size_t dim>
...
typedef math::Box<i32, 1> box1i;
typedef math::Box<i32, 2> box2i;
typedef math::Box<i32, 3> box3i;
typedef math::Box<i32, 4> box4i;
typedef math::Box<u32, 1> box1u;
typedef math::Box<u32, 2> box2u;
typedef math::Box<u32, 3> box3u;
typedef math::Box<u32, 4> box4u;
//=============================================================================
}
