...
#define SG_LOG_DEFAULT_DEBUG(msg)   ((void)0)
#define SG_LOG_DEFAULT_INFO(msg)    ((void)0)
#define SG_LOG_DEFAULT_WARNING(msg) ((void)0)
#define SG_LOG_DEFAULT_ERROR(msg)   ((void)0)
