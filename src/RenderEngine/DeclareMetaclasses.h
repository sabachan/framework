...
REFLECTION_DECLARE_METACLASS((sg,renderengine), AbstractShaderResourceDatabaseDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), AbstractSurfaceDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), BaseShaderDescriptor)
...
REFLECTION_DECLARE_METACLASS((sg,renderengine), DebugDumpSurfacesDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), DepthStencilSurfaceDescriptor)
...
REFLECTION_DECLARE_METACLASS((sg,renderengine), InputShaderResourceDatabaseDescriptor)
...
REFLECTION_DECLARE_METACLASS((sg,renderengine), PixelShaderDescriptor)
...
REFLECTION_DECLARE_METACLASS((sg,renderengine), SetAliasesInConstantDatabaseDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), SetBlendStateDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), SetConstantDatabaseDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), SetRenderTargetsDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), SetShaderResourceDatabaseDescriptor)
...
REFLECTION_DECLARE_METACLASS((sg,renderengine), SwapSurfacesDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), TextureSurfaceDescriptor)
REFLECTION_DECLARE_METACLASS((sg,renderengine), VertexShaderDescriptor)
